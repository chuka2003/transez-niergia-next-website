  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <p className="mb-4">
          <strong>A Healthier Alternative to Generators.</strong> Su-Kam’s DSP Pure Sine Wave Inverters (Colossal series) provide reliable, regulated, and stabilized power backup for all types of commercial establishments:contentReference[oaicite:123]{index=123}. They can run everything from lights and fans to air conditioners, elevators, and more – all in a cost-effective and silent manner:contentReference[oaicite:124]{index=124}.
        </p>
        <p className="mb-4">
          The power output from a Su-Kam inverter is often “purer” than grid power, making it 100% safe for even the most sensitive office equipment:contentReference[oaicite:125]{index=125}. Su-Kam inverters have proven to be a reliable alternative to generators in banks (ATMs), hospitals, petrol stations, shopping malls, and other applications, eliminating noise and fumes while providing uninterrupted power.
        </p>
